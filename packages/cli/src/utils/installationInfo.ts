...
import { debugLogger, isGitRepository } from '@pulsai/nika-cli-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (
      ...
      const updateCommand = 'pnpm add -g @pulsai/nika-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @pulsai/nika-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/install/global')) {
      const updateCommand = 'bun add -g @pulsai/nika-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @pulsai/nika-cli@latest';
    return {
