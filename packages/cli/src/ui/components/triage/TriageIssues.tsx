...
import { debugLogger, spawnAsync } from '@pulsai/nika-cli-core';
...
export const TriageIssues = ({
  ...
  const analyzeIssue = useCallback(
    async (issue: Issue): Promise<AnalysisResult> => {
      ...
      const prompt = `
I am triaging GitHub issues for the Nika CLI project. I need to identify issues that should be closed because they are:
