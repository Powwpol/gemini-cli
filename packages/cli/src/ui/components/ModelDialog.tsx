  ...
  const mainOptions = useMemo(() => {
    const list = [
      {
        ...
        description:
          'Let Nika CLI decide the best model for the task: gemini-2.5-pro, gemini-2.5-flash',
    ...
    if (shouldShowPreviewModels) {
      list.unshift({
        ...
        description:
          'Let Nika CLI decide the best model for the task: gemini-3-pro, gemini-3-flash',
