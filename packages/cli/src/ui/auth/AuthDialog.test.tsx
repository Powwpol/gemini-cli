...
import { AuthType, type Config, debugLogger } from '@pulsai/nika-cli-core';
...
describe('AuthDialog', () => {
  ...
  beforeEach(() => {
    ...
    vi.stubEnv('NIKA_CLI_USE_COMPUTE_ADC', undefined as unknown as string);
