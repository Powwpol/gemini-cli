...
export const INFORMATIVE_TIPS = [
  ...
  'Toggle respect for .nikaignore files in context (/settings)…',
  ...
  'Show Nika CLI status in the terminal window title (/settings)…',
  ...
  'Create a project-specific NIKA.md file with /init…',
  ...
  'Reload instructional context from NIKA.md files with /memory refresh…',
  'List the paths of the NIKA.md files in use with /memory list…',
