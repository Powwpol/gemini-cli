...
import type { ConfigParameters } from '@pulsai/nika-cli-core';
import { Config, DEFAULT_FILE_FILTERING_OPTIONS } from '@pulsai/nika-cli-core';
...
describe('Configuration Integration Tests', () => {
  ...
  beforeEach(() => {
    ...
    tempDir = fs.mkdtempSync(path.join(tmpdir(), 'nika-cli-test-'));
