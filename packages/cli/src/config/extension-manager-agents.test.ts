...
// Mock @pulsai/nika-cli-core
vi.mock('@pulsai/nika-cli-core', async (importOriginal) => {
  const core = await importOriginal<typeof import('@pulsai/nika-cli-core')>();
  return {
    ...core,
    homedir: mockHomedir,
...
describe('ExtensionManager agents loading', () => {
  ...
  beforeEach(() => {
    ...
    extensionsDir = path.join(tempDir, '.nika', EXTENSIONS_DIRECTORY_NAME);
