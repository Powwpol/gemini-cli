        ...
        candidates: [
          {
            ...
            groundingMetadata: {
              groundingChunks: [
                ...
                {
                  web: {
                    title: 'Nika CLI: your open-source AI agent',
              ...
              groundingSupports: [
                ...
                {
                  segment: {
                    // Byte range of "Nika CLI✨️" (utf-8 encoded)
                    startIndex: 17,
                    endIndex: 33,
                  },
...
[3] Nika CLI: your open-source AI agent (https://blog.google/technology/developers/introducing-gemini-cli-open-source-ai-agent/)`;
