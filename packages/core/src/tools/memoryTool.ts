...
export const DEFAULT_CONTEXT_FILENAME = 'NIKA.md';
export const MEMORY_SECTION_HEADER = '## Nika Added Memories';

// This variable will hold the currently configured filename for NIKA.md context files.
