...
/**
 * Decoupled LLM request format - stable across Nika CLI versions
 */
...
/**
 * Decoupled LLM response format - stable across Nika CLI versions
 */
...
/**
 * Decoupled tool configuration - stable across Nika CLI versions
 */
