...
/**
 * Traverses upward from startDir to stopDir, finding all NIKA.md variants.
 *
...
/**
 * Loads hierarchical NIKA.md files and concatenates their content.
...
export async function loadServerHierarchicalMemory(
  ...
  if (filePaths.length === 0) {
    if (debugMode)
      logger.debug('No NIKA.md files found in hierarchy of the workspace.');
