...
export const EXTENSIONS_CONFIG_FILENAME = 'nika-extension.json';
export const INSTALL_METADATA_FILENAME = '.nika-extension-install.json';

/**
 * Extension definition as written to disk in nika-extension.json files.
